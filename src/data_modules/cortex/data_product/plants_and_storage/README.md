...
Defines the hierarchical structural mapping of enterprise plants, storage locations, and storage bins. It underpins granular warehouse layout analysis, stock placement logic, and logistical capacity planning.
...
| :--- | :--- | :--- |
| `plants` | Establishes plant master data from SAP T001W mapping individual plant units to addresses, organizational assignments, and operational parameters. | `SAP ECC` / `SAP S/4HANA` |
| `storage_locations` | Captures warehouse/storage location master data from SAP T001L, mapping locations to their corresponding plants and divisions. | `SAP ECC` / `SAP S/4HANA` |
